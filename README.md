...
(daily brief + new-holding research), which call the OpenAI API using **your own** API key —
you pay OpenAI directly, pay-per-use, typically cents to a few dollars a month for personal
or small-group use. Nobody else's usage is billed to you, and you aren't billed for anyone
else's. Everything else (GitHub, Vercel hosting, Vercel KV storage) runs on their free tiers.
See [Prerequisites](#1-prerequisites) below for how to get an OpenAI key.
...
[MIT](LICENSE) — free to use, modify, and deploy for your own portfolio tracking.
